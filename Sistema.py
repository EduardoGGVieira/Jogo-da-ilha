...
#           lista_opcoes.append('Econtra sobreviventes')
#           break
...
# #ECONTRA OS SOBREVIVENTES EM A
# if lista_opcoes[1] == 'Econtra sobreviventes':
#     while True:
#         sleep(0.5)
#         linha('~',alinhamento)
...
#         sleep(0.5)
#         linha('~',alinhamento)
#         opcoes = ['Verificar os bolsos','Você anda em direção a sons na mata.','Status do personagem']
#         listas(opcoes, True)  
#         resposta = apenasitem(contagem_itens(opcoes), '\nSua opção: ')
...
#           lista_opcoes.append('econtra sobreviventes machucado')
#           break
...
#     #Depois de ser atacado pelos insetos A
#     if lista_opcoes[2] == 'um pouco machucado pelos insetos':
#         pass  # Adicione o código apropriado aqui, se necessário

#     #É SALVO PELO BARCO OU NÃO A
#     if len(lista_opcoes) > 9 and lista_opcoes[9] == 'outro lado da ilha A':
#         while True:
#             sleep(0.5)
#             linha('~',alinhamento)
#             opcoes = ['Verificar os bolsos','Você avista um barco e decide gritar.','Você avista um barco e decide correr.','Status do personagem']
